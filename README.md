...
- **Seven UDA methods** under one shared training interface: Source-Only baseline, ADVENT, CBST and **DARES** (the proposed α-Rényi alignment).
...
├── losses/              # CE, domain (discriminator), advent, cbst, dares_loss (DARES)
├── engines/             # source_only, advent, cbst, dares trainers + registry
