...
Examples:
    ...
    python scripts/train.py --config configs/LIME_stress/medium/dares.yaml --method dares
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="DARES training script (source_only / advent / cbst / clan / dacs / fda / dares)"
    )
    parser.add_argument(
        "--config",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Override the training method (source_only, advent, cbst, clan, dacs, fda, dares)",
    )
    parser.add_argument(
        "--device",
        type=str,
